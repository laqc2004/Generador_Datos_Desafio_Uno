...
public class Desafio {
   private List<String> fechaO = new ArrayList<String>();
   private List<String> fechaF = new ArrayList<String>();
	
	public SalidaDesafio desarrollo()
	{
		  try {
	            ...
	            SalidaDesafio datos= new SalidaDesafio();
	            ...
	            // se crear los archivos
	            crearArchivo(fechaO,"fechasObtenida.txt","fechas òbtenidas:");
	            crearArchivo(fechaF,"fechasFaltantes.txt","fechas faltantes:");
	             datos.setfCreacion(fCreacion);
	             datos.setfFin(fFin);
	             datos.setfFaltantes(fechasFaltantes);
	             datos.setfRecibidas(fechaObtenidas);
	...
	public Date sumarMes(Date date)
	{
	...
	public void crearArchivo(List<String> datos,String nombre ,String formato )
	{
